...
# ────────── CANDIDATES ────────────────────────────────────────────────────────
CANDIDATE_FILES = {
    # proletariāts (skolēnu nominācijas)
    ...
    "Durasel zaķēns":     {"file": "zakens.xlsx",       "description": "Draugs, kuram pēc desmitās stundas vēl joprojām ir enerģija, allaž uzlādēts un vienmēr gatavs jokoties – īsts “Duracel” bateriju zaķēns."},
    ...
    # buržuāzija (skolotāju nominācijas)
